...
export function saveSession(request: ExpressRequest, user: User, metadata: SessionMetaData){
...
export function destroySession(request: ExpressRequest, configService: ConfigService) {
    return new Promise((resolve, reject) => {
