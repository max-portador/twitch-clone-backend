	...
	xo.exports = (function () {
		...
		return function (t, r) {
			...
			var a = 0,
				...
				N = [];
			for (l = 0; l < i; l++)
				(N.push(l + 1), N.push(t.charCodeAt(s + l)));
...
function uu(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = ye(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? ye(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
...
${a.backtrace}`,
	...
	getExternalAdapterError(t, r) {
		if (t.error_code === Fp && r) {
			...
			return (
				sr(i, 'External error with reported id was not registered'),
				i
			);
		}
	}
