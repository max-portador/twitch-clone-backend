...
function Fp(e, r) {
	...
	return (
		!e.s || !r.s
			? (t = new this(NaN))
			: !e.d && !r.d
				? ((t = we(this, o, 1).times(r.s > 0 ? 0.25 : 0.75)),
					(t.s = e.s))
				: !r.d || e.isZero()
					? ((t = r.s < 0 ? we(this, n, i) : new this(0)),
						(t.s = e.s))
					: !e.d || r.isZero()
			...
			(this.startPromise !== void 0 && (await this.startPromise),
				(this.startPromise = (async () => {
					...
					((this.host = t.host),
						...
						(this.remoteClientVersion = await _l(
							this.host,
							this.config,
						)),
						$t('host', this.host),
...
You may have to run ${qe('prisma generate')} for your changes to take effect.`,
	...
	async stop() {
		if (
			...
			return (
				Ce('library is already stopping'),
				this.libraryStoppingPromise
			);
